...
import time
for segundos in range(10,0,-1): # Realizamos un programa que contee de final a principio. (inicio:fin:reverse) Para ello colocamos al final -1, para que sea en reversa
    print(segundos)
